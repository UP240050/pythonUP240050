...
def are_all_items_unique(input_list):
    ...
    return len(unique_items) == len(input_list)
...
def most_spoken_languages(countries, top_n=10):
    ...
    for country in countries:
        ...
        for language in country['languages']:
            if language in language_population:
                language_population[language] += population
            else:
                language_population[language] = population

    sorted_languages = sorted(language_population.items(), key=lambda item: item[1], reverse=True)
...
top_languages = most_spoken_languages(languages_data, top_n=10)
for language, population in top_languages:
...
print(most_populated_countries(languages_data))
